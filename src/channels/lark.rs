...
/// Valid Feishu/Lark API `emoji_type` identifiers.
///
/// These must be the internal API names (SCREAMING_CASE), **not** display
/// names or localised labels.  The canonical list lives at:
